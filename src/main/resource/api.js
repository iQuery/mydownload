...
function navigationTemplate(root) {
    return function(data) {
        ...
        var url = item.path;
		var basePath = "https://docs.telerik.com/kendo-ui/";
        ...
        if (url.indexOf("#") < 0) {
            ...
            while (item = item.parentNode()) {
				//https://docs.telerik.com/kendo-ui/api/https://docs.telerik.com/kendo-ui/javascript/router
				
                node = item.path + "/" + node ;
				
				//javascript/https://docs.telerik.com/kendo-ui/effects
				//https://docs.telerik.com/kendo-ui/api/javascript/pdf
            }
...
var dojoApi = (function($) {
    ...
    var dojoApi = {
        ...
        wrapInHtml: function(snippet) {
            ...
            var result = ('<!DOCTYPE html>\n'+
                ...
                '    <link rel="stylesheet" href="kendo.common.min-1.css"/*tpa=https://kendo.cdn.telerik.com/kendo-version/styles/kendo.common.min.css*//>\n'+
                '    <link rel="stylesheet" href="kendo.rtl.min.css"/*tpa=https://kendo.cdn.telerik.com/kendo-version/styles/kendo.rtl.min.css*//>\n'+
                '    <link rel="stylesheet" href="kendo.silver.min.css"/*tpa=https://kendo.cdn.telerik.com/kendo-version/styles/kendo.silver.min.css*//>\n'+
                '    <link rel="stylesheet" href="kendo.mobile.all.min.css"/*tpa=https://kendo.cdn.telerik.com/kendo-version/styles/kendo.mobile.all.min.css*//>\n\n'+
    ...
    var template = kendo.template(
        '# if (!html) { #<!doctype html>' +
            ...
            '}' +
            '</style>' +
            '<link rel="stylesheet" href="kendo.common.min-2.css"/*tpa=https://kendo.cdn.telerik.com/${version}/styles/kendo.common.min.css*//>' +
            '<link rel="stylesheet" href="kendo.silver.min-1.css"/*tpa=https://kendo.cdn.telerik.com/${version}/styles/kendo.silver.min.css*//>' +
            '<link rel="stylesheet" href="kendo.mobile.all.min-1.css"/*tpa=https://kendo.cdn.telerik.com/${version}/styles/kendo.mobile.all.min.css*//>' +
            '<link rel="stylesheet" href="kendo.rtl.min-1.css"/*tpa=https://kendo.cdn.telerik.com/${version}/styles/kendo.rtl.min.css*/>' +
